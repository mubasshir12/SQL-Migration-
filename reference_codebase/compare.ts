...
const opt = JSON.parse(fs.readFileSync(new URL('./optimized.json', import.meta.url)));
const ceaz = JSON.parse(fs.readFileSync(new URL('./ceaznet.json', import.meta.url)));
...
fs.writeFileSync('compare_res.txt', out);
console.log('done!');
